  ...
  const [steps, setSteps] = useState<OnboardingStep[]>([
    {
      id: 'welcome',
      title: 'Welcome',
      description: 'Preview how Kin works before you start setup',
      completed: false,
      inProgress: false,
    },
    {
      ...
      description: 'Review Kin’s device-only approach to your data',
      completed: false,
      inProgress: false,
    },
    {
      ...
      description: 'Let Kin match people you know across the app',
      completed: false,
      inProgress: false,
    },
    {
      ...
      description: 'Connect your calendar for meeting context',
      completed: false,
      inProgress: false,
    },
    {
      ...
      description: 'Decide how Kin should learn from email',
      completed: false,
      inProgress: false,
    },
    {
      id: 'sync-window',
      title: 'Sync Window',
      description: 'Choose how much history to import on day one',
      completed: false,
      inProgress: false,
    },
  ]);
